...
public class WorldChunkManagerShadow extends WorldChunkManager {
	/** The biome generator object. */
    private BiomeGenBase biomeGenerator;
    private float shadowTemperature;

    /** The rainfall in the world */
    private float rainfall;

    public WorldChunkManagerShadow(BiomeGenBase par1BiomeGenBase, float par2, float par3)
    {
        this.biomeGenerator = par1BiomeGenBase;
        this.shadowTemperature = par2;
        this.rainfall = par3;
    }
    ...
    public float[] getTemperatures(float[] par1ArrayOfFloat, int par2, int par3, int par4, int par5)
    {
        ...
        Arrays.fill(par1ArrayOfFloat, 0, par4 * par5, this.shadowTemperature);
