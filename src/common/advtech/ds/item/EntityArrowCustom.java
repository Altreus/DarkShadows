...
public class EntityArrowCustom extends EntityArrow {
	...
	public EntityArrowCustom(World par1World) {
		super(par1World);
	}
	
	public EntityArrowCustom(World worldObj, EntityPlayer player, float f) {
            ...
            if (var4 != null)
            {
                if (var4.entityHit != null)
                {
                    ...
                    if (var4.entityHit.attackEntityFrom(var21, var23))
                    {
                        ...
                        {
                        	applyStatusEffects((EntityLiving) var4.entityHit);
    ...
    public DamageSource applyDamage(DamageSource damage) {
    	return damage;
    }
    
    public void applyStatusEffects(EntityLiving target) {}
